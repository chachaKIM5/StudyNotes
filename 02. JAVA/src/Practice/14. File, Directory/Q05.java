...
public class Q05 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 2. File dir 생성하고 listFiles File 배열 만들기
		 3. for문 -> isFile() 통해 유효성 검사 후 lastIndexOf, substring으로 확장자 구하기
		 4.	      -> 확장자를 HashMap의 Key 값으로 추가(추가와 수정이 put으로 같다)
		 		  -> 처음 put으로 추가할 때 value 값에서 nullPointerException 발생 -> 3항 연산자로 해결
		 5. HashMap 배열을 iterator로 loop 돌려 출력
