...
//		System.out.println(rnd.nextInt());	 //-21억 ~ 21억 반환
//		System.out.println(rnd.nextInt(10)); //0~9 반환
		
		int size = 20;
		String[] name1 = { "김", "이", "박", "최", "정", "한", "유", "민", "고", "주" };
		String[] name2 = { "길", "동", "경", "지", "원", "미", "성", "광", "연", "수", "성", "석", "재", "형", "노", "하", "영", "우" };
		String[] address1 = { "서울특별시", "인천광역시", "부산광역시", "제주시", "대구광역시" };
