...
drop table tblFilmcompanymovie;
drop table tblMoviePersonReview;
drop table tblMovieReivew;
drop table tblRatings;
drop table tblAwards;
drop table tblQuote;
drop table tblUser;
drop table tblMovieVideo;
drop table tblMovieCountry;
drop table tblMovieMoviePerson;
drop table tblMovieGenre;
drop table tblPhotoMoviePerson;
drop table tblPhoto;
drop table tblMovie;
drop table tblGenrelist;
drop table tblCountrylist;
drop table tblMoviePerson;
drop table tblFilmcompany;
