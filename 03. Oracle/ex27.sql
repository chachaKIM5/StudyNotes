...
from tblSelf
    ...
    --start with절 생략 시 모든 노드가 시작점이 되는 결과를 한 번씩 다 보여준다
    --start with seq = 1
    --start with name = '홍사장'
...
-- tblDate. 요구사항] 3월 1일 ~ 3월 18일까지 날짜와 함께 근태 정보를 가져오시오.
...
-- ***** 기억, 복습하기! date 자료형으로 원하는 기간의 레코드를 얻어오기
...
insert into tblHoliday values (2, '2022-03-09', '대통령 선거일');
