...
public class OpenAPI01 {
    ...
    public static void main(String[] args) {
        String clientId = "X9mvgD29SuB5ZsK7bGCo"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "hQXbThQ_54"; //애플리케이션 클라이언트 시크릿값"
        ...
        try {
        	...
        	for (Object item : list) {
        		...
        		System.out.println("책 제목: "+ ((JSONObject)item).get("title"));
        	}
