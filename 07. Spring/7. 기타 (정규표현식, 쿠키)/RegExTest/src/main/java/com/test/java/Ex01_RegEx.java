...
public class Ex01_RegEx {
		...
		/*
		 	...
		 	3. 선택, choice
		 		3.1 [열거값]
		 			...
		 			ex) "[123]45" > 12345, 145, 245, 345, 45
		 			ex) "[123]?45" > 12345, 145, 245, 345, 45
					...
					ex) 전화번호 검색
						...
						1900년대생 주민등록번호 검색
						"[0123456789][0123456789][0123456789][0123456789][0123456789][0123456789]-[0123456789][12][0123456789][0123456789][0123456789][0123456789][0123456789]"
		 			...
		 			** 연속된 문자를 간단하게 표현하는 방법
		 			...
		 			ex) 한글 > "[가-힣]"
		 				...
		 				홍씨 성을 가진 사람 3글자 이름 > "홍[가-힣][가-힣]"
		 				
		 			ex) 영문자(대소문자 상관없이) > "[A-Za-z]"
		 			ex) 영문자 + 숫자 > "[A-Za-z0-9]"
		 	...
		 	4. 출현횟수
				...
				4.2 {n,m}
					- n: 최소 출현 횟수
					- m: 최대 출현 횟수
					ex) "a{1,3}bc" > ab, abc, abbc, ac, bc, bbc, aaabc, aabc, aaaaaaaaabc
				...
				ex) 주민등록번호: "[0-9]{6}-{0,1}[0-9]{7}"
				ex) 주민등록번호: "[0-9]{6}-?[0-9]{7}"
				
				ex) 영어단어(3글자): "[A-Za-z]{3}"
		 	...
		 	5. 처음과 끝
		 		...
		 		5.1 ^
		 			- 뒤의 표현으로 반드시 시작
		 			- str.startsWith()
		 			ex) "^홍길동" > 대상 문자열이 '홍'으로 시작하면 찾기
		 		
		 		5.2 $
		 			- 앞의 표현으로 반드시 끝
		 			- str.endsWith()
		 			ex) "홍길동$" > 대상 문자열이 '동'으로 끝나면 찾기
	...
	private static void m5() {
		...
		//matches: 완전 일치 검사 메소드
		String txt = "22";
		System.out.println(txt.matches("[0-9]{2,3}"));
		
		
		//split: 구분자로 정규식 넣기
		//"," 혹은 ";" 1개 or 그 이상으로 split
		...
		//replaceAll (찾은 문자열 모두 대체): 정규식으로 문자열을 찾아 대체하기
		//replaceFirst (첫 번째로 찾은 문자열만 대체)
		//개인정보(전화번호) 마스킹
		String line = "안녕하세요. 제 연락처는 010-2144-2541입니다. 연결이 안되면 010-5896-9854로 연락주세요.";
	...
	private static void m3() {
		...
		String txt = "안녕하세요. 저는 홍길동입니다. hong@gmail.com 어? 당신 이름도 길동이네요? test_123@naver.com 김길동이네요. 1038263@naver.com 저쪽에 최길동도 있어요. 한 명 더 있네요~ 남궁길동이도 있습니다.";
	...
	private static void m2() {
		...
		String txt = "안녕하세요. 저는 홍길동입니다. 어? 당신 이름도 길동이네요? 김길동이네요. 저쪽에 최길동도 있어요. 한 명 더 있네요~ 남궁길동이도 있습니다.";
	...
	private static void m1() {
		...
		String txt = "안녕하세요. 홍길동입니다. 010-1234-5678 지금 정규 표현식을 공부하는 중입니다. 010-8547-9854 밖에 비가 내립니다. 010-235-9999 배가 고픕니다.";
		...
		//System.out.println(m1.find()); // -> true | false
...
//		}
		...
		while (m1.find()) {
			System.out.println("전화번호를 발견했습니다.: " + m1.group());
			System.out.println("앞자리: " + m1.group(1));
			System.out.println("중간자리: " + m1.group(2));
